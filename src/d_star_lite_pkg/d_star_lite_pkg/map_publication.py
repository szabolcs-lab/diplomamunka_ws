...
class MapPublication(Node):
    def __init__(self):
        ...
        self.get_logger().info('Map publication node is initialization....')
        ...
        maps_dir = os.path.join(get_package_share_directory('d_star_lite_pkg'), 'maps')
        ...
        self.get_logger().info('Map publication node has been initialized....')
