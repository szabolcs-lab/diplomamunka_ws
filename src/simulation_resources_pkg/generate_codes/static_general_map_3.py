...
def main():
    ...
    walls = [
        ...
        {"name": "wall8", "x": -5, "y": -5, "size_x": 0.5, "size_y": 3.5, "yaw": 0},
        
        {"name": "wall9", "x": -2, "y": 3, "size_x": 0.5, "size_y": 14, "yaw": 0},   
    ...
    # fájlok neveu
    name_csv = "occupancy_grid_3.csv"
    name_sdf = "custom_world_3.sdf"
    ...
    print("Generált occupancy_grid_3.csv és custom_world_3.sdf fájlokat.")
