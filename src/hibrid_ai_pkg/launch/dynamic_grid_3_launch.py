...
def generate_launch_description():
    ...
    dynamic_obstacles = IncludeLaunchDescription(PythonLaunchDescriptionSource(dynamic_obstacles_launch))
    ...
    ppo_product = Node(
        ...
        parameters=[{
            ...
            "model_file": "./ppo_runs/grid_3/best_latest.pth",
            "lidar_sector": 12,
            "lidar_max_range": 6.0,
            "odom_topic": "/odom",
            "scan_topic": "/scan",
    ...
    metrics_logger = Node(
        ...
        output='screen',
        parameters=[{
            'modszer': 'hibrid_d_star_lite_ppo_nav2_dynamic_grid_3',      
